...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000341199b100000000040e97a0(
...
class phpbbtemplatetwiglexer_00000000341199b100000000040e97a0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c0c3d911a96f852008664 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c0c3d911a975401772555 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c0c3d911a95a295443512 = array(
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, 'set_environment', array('env' => $env), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        return $this->valueHolder5c0c3d911a96f852008664->set_environment($env);
    }
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        return $this->valueHolder5c0c3d911a96f852008664->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        return $this->valueHolder5c0c3d911a96f852008664->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c0c3d911a975401772555 = $initializer;
    }
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__get', array('name' => $name), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        if (isset(self::$publicProperties5c0c3d911a95a295443512[$name])) {
            return $this->valueHolder5c0c3d911a96f852008664->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c0c3d911a96f852008664;
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__isset', array('name' => $name), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__unset', array('name' => $name), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;
    ...
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__clone', array(), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        $this->valueHolder5c0c3d911a96f852008664 = clone $this->valueHolder5c0c3d911a96f852008664;
    }

    public function __sleep()
    {
        $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, '__sleep', array(), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;

        return array('valueHolder5c0c3d911a96f852008664');
    }
    ...
    {
        return $this->initializer5c0c3d911a975401772555;
    }
    ...
    {
        return $this->initializer5c0c3d911a975401772555 && ($this->initializer5c0c3d911a975401772555->__invoke($valueHolder5c0c3d911a96f852008664, $this, 'initializeProxy', array(), $this->initializer5c0c3d911a975401772555) || 1) && $this->valueHolder5c0c3d911a96f852008664 = $valueHolder5c0c3d911a96f852008664;
    }
    ...
    {
        return null !== $this->valueHolder5c0c3d911a96f852008664;
    }
    ...
    {
        return $this->valueHolder5c0c3d911a96f852008664;
    }
