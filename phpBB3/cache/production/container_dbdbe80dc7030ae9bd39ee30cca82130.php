...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007a59d60d000000001ba7bc39(
...
class phpbbtemplatetwiglexer_000000007a59d60d000000001ba7bc39 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c0c3ccdaaf5d042382947 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c0c3ccdaaf63727350393 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c0c3ccdaaf48331793932 = array(
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, 'set_environment', array('env' => $env), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        return $this->valueHolder5c0c3ccdaaf5d042382947->set_environment($env);
    }
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        return $this->valueHolder5c0c3ccdaaf5d042382947->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        return $this->valueHolder5c0c3ccdaaf5d042382947->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 = $initializer;
    }
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__get', array('name' => $name), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        if (isset(self::$publicProperties5c0c3ccdaaf48331793932[$name])) {
            return $this->valueHolder5c0c3ccdaaf5d042382947->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c0c3ccdaaf5d042382947;
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__isset', array('name' => $name), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__unset', array('name' => $name), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;
    ...
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__clone', array(), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        $this->valueHolder5c0c3ccdaaf5d042382947 = clone $this->valueHolder5c0c3ccdaaf5d042382947;
    }

    public function __sleep()
    {
        $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, '__sleep', array(), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;

        return array('valueHolder5c0c3ccdaaf5d042382947');
    }
    ...
    {
        return $this->initializer5c0c3ccdaaf63727350393;
    }
    ...
    {
        return $this->initializer5c0c3ccdaaf63727350393 && ($this->initializer5c0c3ccdaaf63727350393->__invoke($valueHolder5c0c3ccdaaf5d042382947, $this, 'initializeProxy', array(), $this->initializer5c0c3ccdaaf63727350393) || 1) && $this->valueHolder5c0c3ccdaaf5d042382947 = $valueHolder5c0c3ccdaaf5d042382947;
    }
    ...
    {
        return null !== $this->valueHolder5c0c3ccdaaf5d042382947;
    }
    ...
    {
        return $this->valueHolder5c0c3ccdaaf5d042382947;
    }
